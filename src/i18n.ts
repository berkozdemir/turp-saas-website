...
const resources = {
  tr: {
    translation: {
      ...
      "form_select": "Seçiniz",
      "form_opt_rwe": "RWE / Gözlemsel",
      "form_opt_int": "Girişimsel (Interventional)",
      "form_opt_device": "Tıbbi Cihaz",
      "form_kvkk": "KVKK / Aydınlatma Metni'ni okudum, onaylıyorum.",
      "form_send": "Hesaplamaya Başla",
  ...
  en: {
    translation: {
      ...
      "form_email": "Corporate Email", "form_phone": "Phone",
