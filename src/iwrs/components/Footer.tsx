    ...
    <>
      ...
      <footer className="bg-gradient-to-br from-gray-900 to-black text-gray-200 mt-auto">
        <div className="container mx-auto py-12 px-4 grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-gray-700">
          ...
          {/* Bölüm 4: Bülten ve İletişim */}
          <div>
            <h3 className="text-lg font-semibold text-white mb-4">{t("footer.newsletter")}</h3>
            <p className="text-sm text-gray-400 mb-4">{t("footer.newsletter_description")}</p>
            <div className="flex space-x-2">
              <Input type="email" placeholder={t("footer.email_placeholder")} className="flex-grow bg-gray-800 border-gray-700 text-white placeholder-gray-500" />
              <Button className="bg-primary hover:bg-primary/90 text-white">{t("footer.subscribe_button")}</Button>
            </div>
            
            <h3 className="text-lg font-semibold text-white mt-8 mb-4">{t("footer.contact_info")}</h3>
