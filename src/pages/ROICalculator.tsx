...
export const ROICalculator = ({ initialCurrency = 'TRY' }) => {
    ...
    const siteCost_Trad = investigatorFee + examFee + patientTravelFee; // Tüm site masrafları var
    
    const traditionalCostPerVisit = craCostPerVisit_Trad + sdcCostPerVisit_Trad + siteCost_Trad;
    ...
    // ÖNEMLİ GÜNCELLEME: Turp ile Site/Muayene/Yol masrafı SIFIR kabul ediliyor.
    // "Turp ile çalışırsanız bu masraflar tamamen ortadan kalkar" iddiası.
    const siteCost_Turp = 0; 
    
    const turpOperationalCostPerVisit = turpCraCostPerVisit + turpSdcCostPerVisit + siteCost_Turp;
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-lg relative">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between border-b border-slate-100 pb-2"><span className="text-slate-500 flex gap-2"><Calendar size={16}/> {t("roi_others")}</span><span className="font-bold text-red-600">{formatCurrency(patientCount * visitCount * siteCost_Trad)}</span></div>
                            ...
                            <div className="bg-slate-900 p-8 rounded-3xl border border-slate-800 shadow-xl relative overflow-hidden">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {/* DİKKAT: BURASI ARTIK 0 TL GÖSTERİYOR */}
                                    <div className="flex justify-between border-b border-slate-800 pb-2"><span className="text-slate-400 flex gap-2"><Calendar size={16}/> {t("roi_others")}</span><span className="font-bold text-green-400">0 {currency}</span></div>
